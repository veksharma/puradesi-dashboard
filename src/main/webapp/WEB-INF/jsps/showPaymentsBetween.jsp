...
<form name="myForm" action="getPaymentsBetween" onsubmit="return validateForm()" method="post">
<pre>
Enter username : <input type="text" name="userName" /> 
Enter from date like 2019-11-31 : <input type="text" name="fromDate" /> Enter to date : <input type="text" name="toDate" />   <input type="submit" class="btn btn-success" value="Get Payments" />
</pre>
</form>
...
$(document).ready(function() {
	...
	$('#example tbody').on( 'click', 'button', function () {
        ...
        var url = "deletePayment?id=" + data.id;
        window.open(url);
        console.log(data);
    } ); 
